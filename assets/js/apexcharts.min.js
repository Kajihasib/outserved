								...
								var d = function (s) {
										...
										if (
											...
											(u.textContent = Array.isArray(c.text) ? c.text.join(' ') : c.text),
												...
												'' !== c.text &&
													(e.drawnLabels.push(c.text), e.drawnLabelsRects.push(c));
										}
										n += t;
									},
									g = 0;
						...
						value: function (t) {
							...
							if (s.config.grid.xaxis.lines.show || s.config.xaxis.axisTicks.show) {
								...
								s.globals.timescaleLabels.length
									? (function (t) {
											for (
												var a = t.xC, s = t.x1, r = t.y1, n = t.x2, o = t.y2, l = 0;
												l < a;
												l++
											)
				...
				a(t, [
					{
						...
						value: function (t, e) {
							...
							return (
								l[l.length - 2] >= e && l.pop(), { result: l, niceMin: l[0], niceMax: l[l.length - 1] }
							);
						},
					},
					{
											  ...
											  n.forEach(function (t, e) {
													if (s[e] <= i.xaxis.max && s[e] >= i.xaxis.min) {
														...
														a.globals.series.forEach(function (i, a) {
															null !== t &&
																((r = Math.min(i[e], r)), (n = Math.max(i[e], n)));
														}),
															n > c && null !== n && (c = n),
															r < h && null !== r && (h = r);
													}
							...
							for (var d = 0; d < t.length; d++) {
								...
								if (
									...
									if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
										...
										void 0 !== P &&
											(C = P(i.globals.seriesPercent[d][0], { seriesIndex: d, w: i }));
